    ...
    def __init__(self, api_client=None):
        ...
        def __calendar_ical_get(
            ...
            **kwargs
            ...
            >>> thread = api.calendar_ical_get(async_req=True)
            >>> result = thread.get()
        ...
        self.calendar_ical_get = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/calendar/ical',
                'operation_id': 'calendar_ical_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__calendar_ical_get
        )

        def __calendar_ical_sharing_link_get(
            self,
            **kwargs
        ):
            ...
            >>> thread = api.calendar_ical_sharing_link_get(async_req=True)
            >>> result = thread.get()
        ...
        self.calendar_ical_sharing_link_get = _Endpoint(
            settings={
                'response_type': (InlineResponse2003,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/calendar/ical/sharing-link',
                'operation_id': 'calendar_ical_sharing_link_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__calendar_ical_sharing_link_get
        )
