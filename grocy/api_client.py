...
from grocy import rest
from grocy.configuration import Configuration
from grocy.exceptions import ApiTypeError, ApiValueError, ApiException
from grocy.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BatteriesApi()
        api_instance.batteries_battery_id_charge_post  # this is an instance of the class Endpoint
        api_instance.batteries_battery_id_charge_post()  # this invokes api_instance.batteries_battery_id_charge_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.batteries_battery_id_charge_post.callable or self.callable in this class
