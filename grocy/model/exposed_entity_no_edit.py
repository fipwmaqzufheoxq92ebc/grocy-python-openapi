...
class ExposedEntityNoEdit(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ExposedEntityNoEdit - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["stock_log", "api_keys", "stock", "stock_current_locations", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["stock_log", "api_keys", "stock", "stock_current_locations", ]  # noqa: E501
