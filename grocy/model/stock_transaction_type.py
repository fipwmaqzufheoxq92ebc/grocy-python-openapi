...
class StockTransactionType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """StockTransactionType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["purchase", "consume", "inventory-correction", "product-opened", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["purchase", "consume", "inventory-correction", "product-opened", ]  # noqa: E501
