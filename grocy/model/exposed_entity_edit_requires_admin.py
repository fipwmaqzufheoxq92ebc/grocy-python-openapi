...
class ExposedEntityEditRequiresAdmin(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ExposedEntityEditRequiresAdmin - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "api_keys", must be one of ["api_keys", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "api_keys", must be one of ["api_keys", ]  # noqa: E501
